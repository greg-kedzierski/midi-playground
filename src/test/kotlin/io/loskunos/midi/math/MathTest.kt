...
class MathTest {
    @Test
    fun `gcd should calculate greatest common divisor of two numbers`() {
        gcd(10, 5) shouldBe 5
        gcd(5, 10) shouldBe 5
        gcd(12, 8) shouldBe 4
        gcd(8, 12) shouldBe 4
    ...
    @Nested
    inner class LessCommonMultiple {
        @Test
        fun `should calculate least common multiple of two numbers`() {
        ...
        @Test
        fun `should calculate least common multiple of list of numbers`() {
